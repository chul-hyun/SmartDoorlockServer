...
var resetRsaInfoInterval = 1000 * 10;
...
router.use(function (req, res, next) {
    ...
    //복호화
    req.body = _rsa2.default.decodeJSON(screetData, rsaInfo.d, rsaInfo.N);
    // 다음함수 실행
    next();
});
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    ...
                    case 7:
                        passDoorlockKey = _context2.sent;
